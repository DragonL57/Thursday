...
- Use **italics** for emphasis or to highlight specific points.
- Use **code blocks** for code snippets, but only if the user specifically asks for them.
- Use **inline code** for short code references: `print("Hello, World!")`. 
...
def get_core_system_prompt():
    ...
    **Tool Use Strategy: Be Proactive, Assume Limited Knowledge**
    ...
    - **Information Gathering Strategy:**
        ...
        3. Follow up with `get_website_text_content` to read promising results. (optional, you can skip this step if the search results are sufficient)
        4. When exploring topics, you can use multiple searches to gather comprehensive information.
